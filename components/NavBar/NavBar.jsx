    ...
    return (
        <div className= {Style.NavBar}>
            ...
            <div className = {Style.NavBar_box_left}>
                <Image src={images.logo} alt="logo"width ={50} height ={50}/> </div>
            ...
            {openModel && (
                ...
                title = "WELCOME TO"
                head = "LinkB CHAT DApp"
                info = "Welcome to this chat dapp, This is made throught the help of VS code , hardhat ,node.js ,next.js ,..etc "
